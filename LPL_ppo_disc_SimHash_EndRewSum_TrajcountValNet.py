"""
    ...
    Intrinsic ValueNet fix:  provide i_episode as additional info as input
"""
...
value_net_in = ValueNet(input_size + 1).to(device)      # One additional input unit to indicate trajectory number
