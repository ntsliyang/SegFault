...
def plot_durations(episode_rewards=None, episode_loss=None, hash_loss=None, idx_range=None, mean_interval=5):
    ...
    if episode_loss is not None:
        ...
        if idx_range is None:
            ...
            ax2.plot(x_axis, episode_loss[start_idx : end_idx])

    if hash_loss is not None:
        # Plot episode value net loss
        ax3.cla()
        ax3.set_title('Hash Loss')
        ...
        if idx_range is None:
            ...
            ax3.plot(x_axis, hash_loss[start_idx: end_idx])
